...
# Hola, Hola ---- Este pedazo es el que baja el mapa de Medellín recortado
#Download Medellin 75.6261,6.1487,-75.5001,6.3405
fp = download_osm(-75.6261,6.1487,-75.5001,6.3405,highway_cat)
texto = fp.read()
archivo = codecs.open('medellin_colombia_recortado.osm', mode="w", encoding="utf-8")
archivo.write(texto.decode('utf-8'))
archivo.close()
# Adios, Adios ---- Este pedazo es el que baja el mapa de Medellín recortado
...
arbol = xml.etree.ElementTree.fromstring(texto)
archivo = codecs.open('medellin_colombia_recortado.txt', mode="w", encoding="utf-8")
